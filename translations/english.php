...
$language[$lng]['title_newthread'] = 'New Thread';
$language[$lng]['title_newpost'] = 'New Post';
$language[$lng]['title_editthread'] = 'Edit Thread';
...
$language[$lng]['post_control_edit'] = 'Edit thread';
$language[$lng]['post_control_reply'] = 'Add Reply';
$language[$lng]['post_control_delete'] = 'Delete thread';
$language[$lng]['thread_name'] = 'Thread Name';
$language[$lng]['thread_content'] = 'Thread';
$language[$lng]['thread_post'] = 'Post thread';
$language[$lng]['thread_save'] = 'Save thread';
$language[$lng]['thread_newthread'] = 'Post a thread in {catname}';
$language[$lng]['post_content'] = 'Post';
$language[$lng]['post_post'] = 'Post';
$language[$lng]['post_delete'] = 'Delete Post';
